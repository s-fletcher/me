  ...
  <Box my={32}>
    ...
    <VStack spacing={8} mt={12}>
      ...
      <Text minW="100%">
        ...
        this process and prevent bottlenecks and allow hackers to get hacking,
        faster.
      </Text>
      <Text minW="100%">
        This involved introducing an automated way of distributing QR codes to
        hackers that were used to check them in at the event.
      </Text>
      <Text minW="100%">
      ...
      <Text minW="100%">
        ...
        <UnorderedList pl={8} minW="100%">
          ...
          <ListItem>Transferring domain to Cloudflare </ListItem>
